...
public class CalculoHTTP {
    ...
    private static int NUMERO_TOTAL_PARAMETROS = 1;
        ...
        try {
            ...
            while (true) {
                ...
                if (info[RESOURCE_POSITION].equalsIgnoreCase("suma")
                        || info[RESOURCE_POSITION].equalsIgnoreCase("resta")) {
    ...
    // Método para generar la página HTML de respuesta con el resultado de la
    // operación
