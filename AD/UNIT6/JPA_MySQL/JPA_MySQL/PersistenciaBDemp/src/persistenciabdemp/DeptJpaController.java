...
public class DeptJpaController implements Serializable {
   ...
   // public DeptJpaController(UserTransaction utx, EntityManagerFactory emf) {
  ...
  /* public DeptJpaController(){
       emf=Persistence.createEntityManagerFactory("PersistenciaBDempPU");
   }*/
    ...
    private List<Dept> findDeptEntities(boolean all, int maxResults, int firstResult) {
        ...
        try {
            ...
            CriteriaQuery select = cq.select(cq.from(Dept.class));
