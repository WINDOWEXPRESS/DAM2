...
jQuery(document).ready(function($){
    ...
    $("#moon").click(function() {
        ...
        if ($('.example_code span').length > 0) {
            $(".example_code span").each(function(index, element) {
                // 获取当前style属性的值
                if ($(element).attr('style')) {
                    var currentStyle = $(element).attr("style");
                    // 使用replace方法将#000066替换为#2e95d3
                    currentStyle = currentStyle.replace("#000066", "#2e95d3");
                    currentStyle = currentStyle.replace("#800080","#da9edaeb");
                    currentStyle = currentStyle.replace("#000","#fff");
                    currentStyle = currentStyle.replace("#000000","#ffffff");
                    // 更新<span>元素的style属性
        ...
        if ($('.example_code span').length > 0) {
            $(".example_code span").each(function(index, element) {
                if ($(element).attr('style')) {
                    ...
                    var currentStyle = $(element).attr("style");
                    // 使用replace方法将#000066替换为#2e95d3
                    currentStyle = currentStyle.replace("#2e95d3","#000066");
                    currentStyle = currentStyle.replace("#da9edaeb","#800080");
                    currentStyle = currentStyle.replace("#fff","#000");
                    currentStyle = currentStyle.replace("#ffffff","#000000");
